...
const Form = ({btn}) => {
    ...
    const submitFormHandler = async() => {
        if (btn === "signup") {
            if (formData.name == "" || formData.email == "" || formData.password == "" || formData.cpass == "") {
            ...
            <div className="max-w-[70%] mx-auto flex flex-col gap-7 mt-8">
            {
                ...
                <div>
                    <div className="relative">
                        ...
                        <div className="absolute right-5 top-4 cursor-pointer" onClick={showPassHandler}>
                        {
                            showPass ? 
                ...
                
            {
                ...
                <div>
                    <div className="relative">
                        ...
                        <div className="absolute right-5 top-4 cursor-pointer" onClick={showConPassHandler}>
                        {
                            showConPass ? 
                            <IoEye fontSize="1.6rem" /> :
                            <IoEyeOff fontSize="1.6rem" />
                ...
                <div>
                    ...
                    onClick={submitFormHandler}>{btn}</button>
                </div>
            </div>
        </div>
    )
